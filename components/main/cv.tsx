    ...
    <Card>
      ...
      <CardContent className="flex justify-end flex-col gap-3">
        <Link href={cvConfig?.link} target="_blank" aria-label="viewCv">
          <Button
            className="w-full flex justify-between h-7 2xl:h-8 3xl:h-10"
            aria-label="viewCv"
          >
            <p className="small-text">View DEMO NOT WORKING...</p>
        ...
        <Link href={cvConfig?.link} target="_blank" aria-label="downloadCv">
          ...
          >
            <p className="small-text">Download DEMO NOT WORKING...</p>
